...
#pragma region Converted OOP code
	...
	{
		/* x     y     z    d4 |   R     G     B   A   */
		-0.5f, 0.1f, 0.0f, 0.0f, 0.0f, 0.5f, 0.5f, 1.0f,
		-0.5f, 0.5f, 0.0f, 0.0f, 0.0f, 0.5f, 0.5f, 1.0f,
		-0.1f, 0.5f, 0.0f, 0.0f, 0.0f, 0.5f, 0.5f, 1.0f
	};
	...
	PointData squareTriangle2[] =
	{
		-0.5f, 0.1f, 0.0f, 0.0f, 0.0f, 0.5f, 0.5f, 1.0f,
		-0.1f, 0.5f, 0.0f, 0.0f, 0.0f, 0.5f, 0.5f, 1.0f,
		-0.1f, 0.1f, 0.0f, 0.0f, 0.0f, 0.5f, 0.5f, 1.0f
	};


#pragma region Insert GeneralModel objects to Application
	app->AddObject(app->factory->CreateGeneralModel(triangle1, 3, 3));
	app->AddObject(app->factory->CreateGeneralModel(triangle2, 3, 3));
	app->AddObject(app->factory->CreateGeneralModel(squareTriangle1, 3, 3));
	app->AddObject(app->factory->CreateGeneralModel(squareTriangle2, 3, 3));
#pragma endregion
