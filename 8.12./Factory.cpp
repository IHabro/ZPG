...
Object* Factory::CreateSkyBox(FactoryParams params, glm::mat4 matrix)
{
	...
	ModelSkyBox modelSkybox = ModelSkyBox();
	GeneralModel* gm = &modelSkybox;
	ShaderProgram* sp = new ShaderProgram(params.shader.vertex, params.shader.fragment, 
										  params.scene->ReturnCamera(), params.scene->ReturnLight());
