...
#pragma region Object Scene Prep
	Scene* sc = new Scene();
	sc->AddObjectObj(app->factory->CreateSphereObj("default.vert", "default.frag", glm::translate(glm::mat4(1.0f), glm::vec3(2.5f, 0.0f, 0.0f))));
	sc->AddObjectObj(app->factory->CreateSphereObj("default.vert", "default.frag", glm::translate(glm::mat4(1.0f), glm::vec3(-2.5f, 0.0f, 0.0f))));
	sc->AddObjectObj(app->factory->CreateSphereObj("default.vert", "default.frag", glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 2.5f, 0.0f))));
	sc->AddObjectObj(app->factory->CreateSphereObj("default.vert", "default.frag", glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, -2.5f, 0.0f))));
#pragma endregion
