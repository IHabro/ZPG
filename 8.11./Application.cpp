...
void Application::SetActiveScene(int num)
{
	...
	this->scene = this->scenes[num];
}

void Application::AddLight(glm::vec3 light)
{
...
void Application::Run()
{
	...
	while (!glfwWindowShouldClose(this->window))
	{
	   ...
	   this->shaderProgram->SetLightPosition(this->lightPosition);
	   this->shaderProgram->SetCameraPosition(this->scene->GetCameraPosition());

	   glm::mat4 moveMat0 = glm::translate(glm::mat4(1.0f), glm::vec3(2.5f, 0.0f, 0.0f));
	   glm::mat4 moveMat1 = glm::translate(glm::mat4(1.0f), glm::vec3(-2.5f, 0.0f, 0.0f));
	   glm::mat4 moveMat2 = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 2.5f, 0.0f));
	   glm::mat4 moveMat3 = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, -2.5f, 0.0f));

	   this->scene->SetModelMatrixForNthObject(moveMat0, 0);
